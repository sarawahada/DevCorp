...
public class ProductsController implements Initializable {
    ...
    private VBox productView(Product product) throws FileNotFoundException {
        ...
        FileInputStream input = new FileInputStream("C:\\Users\\fomri\\Documents\\Chahine\\Final\\CRUDPI2\\MyApp\\src\\resources\\" + product.getImageFile());
        ...
        addBtn.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                  ...
                  panier.addProduct(productName,getUser());
